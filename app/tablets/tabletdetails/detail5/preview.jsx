          ...
          <div className="flex justify-center lg:justify-end">
            <div className="w-full max-w-md sm:max-w-lg lg:max-w-none border-2 border-gray-200 rounded-2xl p-6 sm:p-8 lg:p-10 bg-white">
              <div className="relative aspect-square w-full">
                <img src="https://encrypted-tbn0.gstatic.com/shopping?q=tbn:ANd9GcSUZSPAIEk_Mh6TVhxqx-2_41STyVDo-4qqydSgjpa3qLGTonLxWCOOxFTXlLQ0J8q1hUDHOUpvX1ntnoRZ3CcZ0XMRSymSmXJaHtCL6tSk&usqp=CAc" 
                className="object-contain w-full h-full"
          alt="Android Tablet, 2025 Tablet 10 Inch Android 15 Tablets, Quad Core Processor 12(3+9)GB RAM 64GB ROM | 6000mAh Battery, 1TB Expand |1280 * 800 HD IPS Touchscreen | WiFi 6 | 2+8MP, 2in 1 Tablet with Keyboard, Mouse, Pen, Protective Case"
          />
              </div>
            </div>
          </div>
