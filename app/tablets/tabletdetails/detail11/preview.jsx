          ...
          <div className="flex justify-center lg:justify-end">
            <div className="w-full max-w-md sm:max-w-lg lg:max-w-none border-2 border-gray-200 rounded-2xl p-6 sm:p-8 lg:p-10 bg-white">
              <div className="relative aspect-square w-full">
                <img src="https://encrypted-tbn1.gstatic.com/shopping?q=tbn:ANd9GcQnCjQUp7nWjMS0xHATvld2pCbpeSPlWSA7KLL5YqNMZDun5kYkUgzpuwTTkaYjwnTxSJtt2SHr8BJ9YKFV3o5GK6AkB8R9l7hfxTmpDy3TRyCmd3tzA874KQj6S9Zg2BAWLbiJF75udg&usqp=CAc" 
                className="object-contain w-full h-full"
          alt="8GB (4G+4G Expansion) RAM 64GB ROM Android 13 System Equipped with 8-core Chip Intelligent Calling Tablet 10.1-inch 1280*800 IPS Display 6000mAh Large Battery BDF H39 Accessories: (data Cable, Card Pin, OTG, Protective Film, Bracket, Touch Screen"
          />
              </div>
            </div>
          </div>
