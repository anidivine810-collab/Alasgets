          ...
          <div className="flex justify-center lg:justify-end">
            <div className="w-full max-w-md sm:max-w-lg lg:max-w-none border-2 border-gray-200 rounded-2xl p-6 sm:p-8 lg:p-10 bg-white">
              <div className="relative aspect-square w-full">
                <img src="https://encrypted-tbn2.gstatic.com/shopping?q=tbn:ANd9GcQ6Tf5GReiLsvWnHfqbjYKvSOomffC8jRJ2hTAFcK1s_jrwHtYbe_Eg29vWlM4D4mL3OOIvoUe887T-4ZGVwU6fwcYihEdLBIujYi5k9eUM0T7FE770b_gqcWZc8s79r3bK5qcqJCI&usqp=CAc" 
                className="object-contain w-full h-full"
          alt="Teclast P33 New Tablet, Android 15 10.1-Inch IPS, 1280X800 Resolution, Allwinner A333 Five Core, 9GB * (3GB+6GB Virtual Expansion) 64GB Storage Space, WIFI, 6000Mah Type-C Charging, Rear 5MP And Front 2MP Dual HD Cameras, Offer Tablet Case, Table"
          />
              </div>
            </div>
          </div>
