          ...
          <div className="flex justify-center lg:justify-end">
            <div className="w-full max-w-md sm:max-w-lg lg:max-w-none border-2 border-gray-200 rounded-2xl p-6 sm:p-8 lg:p-10 bg-white">
              <div className="relative aspect-square w-full">
                <img src="https://encrypted-tbn1.gstatic.com/shopping?q=tbn:ANd9GcTCNeWDeqzlrTn3GS1rqjN3UwK2mip-nJ38lc4TUliW0K0MSQ08VZPXb12DqWFal4XDigkNPQ3fOty8yXFsb9GUH_4IHhgFXtRGY7hMGPehNOczGbwcxF0CBGdm8RZ_JA0i3jweqoNKVGM&usqp=CAc" 
                className="object-contain w-full h-full"
          alt="10.1-inch Android 13 Tablet, 4GB RAM 64GB ROM Tablet, 1920*1200, 5MP+8MP Dual Camera, Wifi & Bluetooth, Applicable to Multiple Scenarios Office School"
          />
              </div>
            </div>
          </div>
