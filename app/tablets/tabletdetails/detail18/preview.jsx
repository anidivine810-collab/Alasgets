          ...
          <div className="flex justify-center lg:justify-end">
            <div className="w-full max-w-md sm:max-w-lg lg:max-w-none border-2 border-gray-200 rounded-2xl p-6 sm:p-8 lg:p-10 bg-white">
              <div className="relative aspect-square w-full">
                <img src="https://encrypted-tbn1.gstatic.com/shopping?q=tbn:ANd9GcTcPm9swbFxWCSLKAUl2I2U0OO-XNVNB2TcAD9_Pi8PGQqv7OqGBQahWb2ajaYIssAOrQE1A5Wde_Jg5Vle7RyQcDaHtrX97cIlDjvVctJotjlntU4zChZVLgLyCqA2xWY-SmSvlg&usqp=CAc" 
                className="object-contain w-full h-full"
          alt="10.1-inch Android 13 Tablet 8 (4G+4G expansion) GB RAM 256GB ROM, 5MP13MP Dual camera, Supports 4G calls, 1280 * 800IPS High-Definition screen 6000mAh Battery Supports 1TB Expansion (no adapter) multi-color selection black/white/blue/green"
          />
              </div>
            </div>
          </div>
