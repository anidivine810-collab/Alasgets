          ...
          <div className="flex justify-center lg:justify-end">
            <div className="w-full max-w-md sm:max-w-lg lg:max-w-none border-2 border-gray-200 rounded-2xl p-6 sm:p-8 lg:p-10 bg-white">
              <div className="relative aspect-square w-full">
                <img src="https://encrypted-tbn0.gstatic.com/shopping?q=tbn:ANd9GcRqiim0Spz5Ilj2y_8qeIX_X9Mey2Xo5vEa6aREawJXi747tdTvW0hXKkdP1eDCZAJakhfg8LgSIIH9-Y54mzh47mn1hbQ9YIHPwIAUWiXG0oIrMsEI0QshtLKK6CtXrEn9UvtvaA&usqp=CAc" 
                className="object-contain w-full h-full"
          alt="Android 14 6GB RAM 128GB ROM Tablet | Dual SIM Dual Standby, WiFi 2.4/5G, Wireless 5.0, Dual Camera 5+8MP, 10.1-inch IPS Display, Includes Data Cable, Card Pin, OTG, Manual, Bracket, Touch Pen, Tablet, Pad"
          />
              </div>
            </div>
          </div>
