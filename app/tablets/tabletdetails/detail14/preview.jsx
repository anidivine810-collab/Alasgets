          ...
          <div className="flex justify-center lg:justify-end">
            <div className="w-full max-w-md sm:max-w-lg lg:max-w-none border-2 border-gray-200 rounded-2xl p-6 sm:p-8 lg:p-10 bg-white">
              <div className="relative aspect-square w-full">
                <img src="https://encrypted-tbn2.gstatic.com/shopping?q=tbn:ANd9GcQ6ALVOvqG3gwnClKPlVww1YogLgr9OiwV5uylNpQms6biI9gENfnS43fBb-KqaT5oMz8k9SOXOimd2GC5G5uOgFB3nYpUpXd5ogl8ngAQ-SVcx1yNY5c5Lm-o0mFq00wj-oScQGLA&usqp=CAc" 
                className="object-contain w-full h-full"
          alt="NANNEE 10.1-inch Tablet Pad10 Ultra, 8GB RAM + 128GB ROM, Built-in GPS, 8MP + 16MP Camera, Android 15, Includes Keyboard, Stylus, Mouse, Charging Cable, and Leather Case"
          />
              </div>
            </div>
          </div>
