          ...
          <div className="flex justify-center lg:justify-end">
            <div className="w-full max-w-md sm:max-w-lg lg:max-w-none border-2 border-gray-200 rounded-2xl p-6 sm:p-8 lg:p-10 bg-white">
              <div className="relative aspect-square w-full">
                <img src="https://encrypted-tbn1.gstatic.com/shopping?q=tbn:ANd9GcTfHNiIBlfQLXUaMTWDq1xPYqHJcU8Phw-X3-FocrqEa39Frvf6HKlLTfRiREcSQA2zvJwQAiJQSIyjz1bzaXCsYGtF3eTnbDK8GlmHZA77zRHFXGKOhtKMWe-GSkL7Q-Mha8I2Yg&usqp=CAc" 
                className="object-contain w-full h-full"
          alt="Tablet Running Android with a Keyboard, Featuring 512GB of Storage, 8GB of RAM, 4G LTE Capability, Android 14, Dual SIM Support, an Octa-Core Processor, And a 2-In-1 Design. It Has a 10.1-Inch Display And Comes with a Case, Stylus"
          />
              </div>
            </div>
          </div>
