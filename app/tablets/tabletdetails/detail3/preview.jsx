          ...
          <div className="flex justify-center lg:justify-end">
            <div className="w-full max-w-md sm:max-w-lg lg:max-w-none border-2 border-gray-200 rounded-2xl p-6 sm:p-8 lg:p-10 bg-white">
              <div className="relative aspect-square w-full">
                <img src="https://encrypted-tbn2.gstatic.com/shopping?q=tbn:ANd9GcSDT4lnzTIk7CKF6c_9d3-KGrf0Pr6MUQLYCa-JkP1uDa1nN28FfBsbrmTDQwIoF9cgIm8PLdRmevHgFodvkwzHWUz1z3OdV8byJcdyaBqt4FvqM2QYbUmDzp7e8sQxMbChv5EJ0w&usqp=CAc" 
                className="object-contain w-full h-full"
          alt="Qetupa 10.1 Inch Android 14 Tablet PC, MTK 6762 Octa-Core 2.0GHz Processor, 8GB RAM+256GB ROM/4GB RAM+128GB ROM, 802.11ax Wi-Fi 6, Bluetooth 5.4, Incell HD (1280*800) IPS Touchscreen, 5MP+13MP Dual Cameras, 6000mAh Battery, Support 512GB Expansion, Type-C Port, No SIM Card Support"
          />
              </div>
            </div>
          </div>
