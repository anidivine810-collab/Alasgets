          ...
          <div className="flex justify-center lg:justify-end">
            <div className="w-full max-w-md sm:max-w-lg lg:max-w-none border-2 border-gray-200 rounded-2xl p-6 sm:p-8 lg:p-10 bg-white">
              <div className="relative aspect-square w-full">
                <img src="https://encrypted-tbn0.gstatic.com/shopping?q=tbn:ANd9GcQn0vgayEDx5g2Dnxwas28zJYy9oIFKjPBRsM77xg_nRLkm8YkFhX6y2ziLjAWl-mTD7XfMtdtiZavb_WeXVbRHo17yumuDAVOA1h1h3RJaXDCV6kuaobo8hp1AVEUhzVM56-Nx6XLHqg&usqp=CAc" 
                className="object-contain w-full h-full"
          alt="PEICHENG 10 Inch Pad Android 15 Tablet, RK3326S 4-Core 8(3+5)GB RAM 32GB ROM, 10.1 Inch Tablet, FHD IPS Touch Screen, 2MP Front 8MP Back Camera, Type-C Tablete G-sensor, 6000mAh Larger Battery"
          />
              </div>
            </div>
          </div>
