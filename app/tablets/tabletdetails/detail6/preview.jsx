          ...
          <div className="flex justify-center lg:justify-end">
            <div className="w-full max-w-md sm:max-w-lg lg:max-w-none border-2 border-gray-200 rounded-2xl p-6 sm:p-8 lg:p-10 bg-white">
              <div className="relative aspect-square w-full">
                <img src="https://encrypted-tbn1.gstatic.com/shopping?q=tbn:ANd9GcTiLeof7hVIxEcN7o60sOrTc2lmURJI2JCLwUu_bAAzmlJJ7f6KfaLaNyoQsZplLopB57TPXQjIZhH5v8fzCSjLcIiprWCck-hMF4_sF58alEZRWzuwR8wqF4YU5W7Gl8rf8Z01GOE&usqp=CAc" 
                className="object-contain w-full h-full"
          alt="Tablet 8GB+256GB 10.1 Inch Screen 5G Calling Snapdragon 888 Processor"
          />
              </div>
            </div>
          </div>
