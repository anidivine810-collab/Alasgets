          ...
          <div className="flex justify-center lg:justify-end">
            <div className="w-full max-w-md sm:max-w-lg lg:max-w-none border-2 border-gray-200 rounded-2xl p-6 sm:p-8 lg:p-10 bg-white">
              <div className="relative aspect-square w-full">
                <img src="https://encrypted-tbn1.gstatic.com/shopping?q=tbn:ANd9GcSxz6a72WrMHpSEa6CHHr3C5R47ZPQx1WKK3ox4pGLCQFJARmqBDUoMOR5soOna44tZc1iimPvkukpZdpLstrmt-8Gf8-lRxoTLIIbNSO_Ew4ZTLwaIWDszEeDAlVpK-Myxtm19ADI4&usqp=CAc" 
                className="object-contain w-full h-full"
          alt="Android 12 Tablet, 4GB RAM + 64GB ROM, Expandable Up to 128GB Via SD Card, Offering Ample Storage. 6000Mah Battery, Supports Wi-Fi 6 And Bittorrent 5.0. A Gaming Tablet, Multimedia Consumer Tablet, Stylish Tablet, Compact Design"
          />
              </div>
            </div>
          </div>
