          ...
          <div className="flex justify-center lg:justify-end">
            <div className="w-full max-w-md sm:max-w-lg lg:max-w-none border-2 border-gray-200 rounded-2xl p-6 sm:p-8 lg:p-10 bg-white">
              <div className="relative aspect-square w-full">
                <img src="https://encrypted-tbn2.gstatic.com/shopping?q=tbn:ANd9GcS21wmqIkDE-o5hd8iOPzy69hpmFRLw9cjg6d3CCw2ff6PUdZ3xs9ZMA6ZPX0NMNHZtFYkbNvL0o21K1uwrfwO5WIlYytKrkcM829A0juOwkJfigq0yUq93XawYsPWVrN0xXXulnzs&usqp=CAc" 
                className="object-contain w-full h-full"
          alt="2025 New Tablet, I-Atar 10.1-inch Android Tablet, 4GB RAM + 64GB ROM Storage; 6000mAh Large Capacity Battery; Stylish Design, 2MP+5MP Dual Camera Configuration; Sleek Internet Connectivity with Type-C Charging Cable Included"
          />
              </div>
            </div>
          </div>
