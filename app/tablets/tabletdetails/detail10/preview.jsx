          ...
          <div className="flex justify-center lg:justify-end">
            <div className="w-full max-w-md sm:max-w-lg lg:max-w-none border-2 border-gray-200 rounded-2xl p-6 sm:p-8 lg:p-10 bg-white">
              <div className="relative aspect-square w-full">
                <img src="https://encrypted-tbn3.gstatic.com/shopping?q=tbn:ANd9GcS5wDUNxZCQYIv8OLvpG9PP9nNA4GrXIKsUYFHElJmkQjwqOqtAq9k2ehbvMWZi_ULw4TLjI_nxGEBdyYqeSHmBM3UQ_o_Sd9HjZvS2q-GDN1NMw2-GzBuJ9PWZIpYl8vZWLu7dnlCiBQA&usqp=CAc" 
                className="object-contain w-full h-full"
          alt="NANNEE-10.1 Inch Global New Tablet Pad9Ultra, with 8GB RAM And 128GB ROM, Supports Wifi 5 And GPS, Features 8MP And 16MP Cameras, Runs on Android 15, And Comes with a Keyboard, Stylus, Mouse, And Leather Case"
          />
              </div>
            </div>
          </div>
