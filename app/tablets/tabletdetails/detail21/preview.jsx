          ...
          <div className="flex justify-center lg:justify-end">
            <div className="w-full max-w-md sm:max-w-lg lg:max-w-none border-2 border-gray-200 rounded-2xl p-6 sm:p-8 lg:p-10 bg-white">
              <div className="relative aspect-square w-full">
                <img src="https://encrypted-tbn2.gstatic.com/shopping?q=tbn:ANd9GcTU3wGVjnIEGvnGaZqo-uOI71eQXyMXjoYSze07GJgE1y56YoCyuD88D9DICaSHByADLZPzwAy_Kc0ROIslpa1pU13iao-SWwvzRwREYG0k9HtVYlzqOt3VGLZt8sNRdJJ2fwI0W5msun4&usqp=CAc" 
                className="object-contain w-full h-full"
          alt="High Tech MacPad Air S25 Ultra 10.1 Incell 16GB RAM 1TB Storage 10,000mAh Bat Android 13 FREE Keyboard, Mouse & Stylus"
          />
              </div>
            </div>
          </div>
