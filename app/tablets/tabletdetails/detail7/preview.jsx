          ...
          <div className="flex justify-center lg:justify-end">
            <div className="w-full max-w-md sm:max-w-lg lg:max-w-none border-2 border-gray-200 rounded-2xl p-6 sm:p-8 lg:p-10 bg-white">
              <div className="relative aspect-square w-full">
                <img src="https://encrypted-tbn0.gstatic.com/shopping?q=tbn:ANd9GcRhjoARrningbiys_k8s6b3QeFlRqLsYDVpUvkZ8U0Npb_6mnGR3f2hcFWLkT1ZMxjkh5zpABNo5Ec2YCD2O1Ld0rKhoTvqhcR-O24GJiHRWtR8Ka2wOSMe&usqp=CAc" 
                className="object-contain w-full h-full"
          alt="Latest Android 15 Tablet, 11.6-inch 2-in-1 Tablet with Keyboard & Protective Case, 8GB RAM + 256GB Storage, 4000mAh Battery, 5G WiFi, 24MP+32MP Dual Cameras, 1280×800 FHD IPS Display"
          />
              </div>
            </div>
          </div>
