          ...
          <div className="flex justify-center lg:justify-end">
            <div className="w-full max-w-md sm:max-w-lg lg:max-w-none border-2 border-gray-200 rounded-2xl p-6 sm:p-8 lg:p-10 bg-white">
              <div className="relative aspect-square w-full">
                <img src="https://encrypted-tbn2.gstatic.com/shopping?q=tbn:ANd9GcRewG1NUg-e686flmC7GLOID9zTt4MsV5HjxKlT188zDGIP3VxTKdDe5KeEPevUoD1CTr6nyeNlrYHC10KLEUQ-3TQyvIDnJc_LxoSLdF4x5ZmqdeyLWoA-xLbvglnLm_5yvs0FxT1y&usqp=CAc" 
                className="object-contain w-full h-full"
          alt="CRELANDER Android 14 Tablet Featuring a 10.1 Inch Unisoc T606 Processor, with a Resolution of 1920X1200 on an IPS Display And a Refresh Rate of 90Hz. It Comes with 4GB of RAM, 8GB of Storage, 256GB of Internal Memory, 13MP And 8MP Cameras"
          />
              </div>
            </div>
          </div>
