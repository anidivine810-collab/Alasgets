          ...
          <div className="flex justify-center lg:justify-end">
            <div className="w-full max-w-md sm:max-w-lg lg:max-w-none border-2 border-gray-200 rounded-2xl p-6 sm:p-8 lg:p-10 bg-white">
              <div className="relative aspect-square w-full">
                <img src="https://encrypted-tbn0.gstatic.com/shopping?q=tbn:ANd9GcQ9R7G7ZSDNPKKc6-HbbJXzpYc1Hchlc6Lv3jgk22NQIkg7UQGBqVTqXgwkP5gln581mUwo-ccpOqUKWmWLoWum_GGha_78E8YcIuWQn2cmhSG-F18DIfmfRhGkRETf6d8camkvvb6gAQ&usqp=CAc" 
                className="object-contain w-full h-full"
          alt="Apple Iphone 16-61 256Gb ROM | 8GB RAM | Single Nano sim| iOS 18| Ultramarine"
          />
              </div>
            </div>
          </div>
