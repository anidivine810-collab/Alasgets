          ...
          <div className="flex justify-center lg:justify-end">
            <div className="w-full max-w-md sm:max-w-lg lg:max-w-none border-2 border-gray-200 rounded-2xl p-6 sm:p-8 lg:p-10 bg-white">
              <div className="relative aspect-square w-full">
                <img src="https://encrypted-tbn2.gstatic.com/shopping?q=tbn:ANd9GcQ_FbePZw9fPm2dXLNWY0KLm2TEGWA4ttnXKnmWIkqJtU1ZbCS6anTaxQRCUK2gS4hSj_GDdC0oxZFmYjuW3aKTGP4wQifuxNJkRAw4ixY8hmSNbn18oz-YIcdUowkAJgOaTbkYEqupzdY&usqp=CAc" 
                className="object-contain w-full h-full"
          alt="Apple Iphone Xs Max 256GB Unlocked Very Good Condition - All Colors"
          />
              </div>
            </div>
          </div>
