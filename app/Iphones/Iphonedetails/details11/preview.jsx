          ...
          <div className="flex justify-center lg:justify-end">
            <div className="w-full max-w-md sm:max-w-lg lg:max-w-none border-2 border-gray-200 rounded-2xl p-6 sm:p-8 lg:p-10 bg-white">
              <div className="relative aspect-square w-full">
                <img src="https://encrypted-tbn3.gstatic.com/shopping?q=tbn:ANd9GcQDz49wSyG_9fNA0HGyjonJmulg1mtAxvsw-mDjKmfn-E4VFBQkldDFJqC6Crei4TKwqZwx6mTeayd8J1dJs3j-77rBnlR9uyAAAmKEdvtW&usqp=CAc" 
                className="object-contain w-full h-full"
          alt="Apple Iphone 14 Pro Max 256GB | 6.7 in | AT&T, Verizon, T-mobile, Spirit | More than 20.0 MP | 5G |iOS | 6GB - All Colors"
          />
              </div>
            </div>
          </div>
