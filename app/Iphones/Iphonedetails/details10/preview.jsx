          ...
          <div className="flex justify-center lg:justify-end">
            <div className="w-full max-w-md sm:max-w-lg lg:max-w-none border-2 border-gray-200 rounded-2xl p-6 sm:p-8 lg:p-10 bg-white">
              <div className="relative aspect-square w-full">
                <img src="https://encrypted-tbn3.gstatic.com/shopping?q=tbn:ANd9GcTW-Qb4RaTZwnuQObsRPdRgapnf_Q9MF_UqqAcPDisMrOhKtRWqiFFtSB6bEd7Nk6d-T9Z5JhFT13QTLaweN0VoijEBFnr-fYhq_mZhuXffP7NGNar7rE0ZUDS90FWXvwl17wUyDOk2&usqp=CAc" 
                className="object-contain w-full h-full"
          alt="Apple IPhone 17 5G (Unlocked) 256GB Dual SIM 6.3in 48MP Always-On display"
          />
              </div>
            </div>
          </div>
