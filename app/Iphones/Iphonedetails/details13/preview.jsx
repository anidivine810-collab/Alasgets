          ...
          <div className="flex justify-center lg:justify-end">
            <div className="w-full max-w-md sm:max-w-lg lg:max-w-none border-2 border-gray-200 rounded-2xl p-6 sm:p-8 lg:p-10 bg-white">
              <div className="relative aspect-square w-full">
                <img src="https://encrypted-tbn1.gstatic.com/shopping?q=tbn:ANd9GcTNH5DoA-AXabna5IP36-CMtEaNiB9cEWsp2B-wAEAzKmRonJdcO-EJeo_6U8-gagt4-HMwP5gvaI59kRYoTdzUb1HnHeGNlutZTgnB82z9fiCKGRimz3_X&usqp=CAc" 
                className="object-contain w-full h-full"
          alt="Apple Iphone 14 Plus  128GB Blue (Unlocked) |6in | Bluetooth | 6GB RAM | iOS| Hexa Core - All Colors"
          />
              </div>
            </div>
          </div>
