          ...
          <div className="flex justify-center lg:justify-end">
            <div className="w-full max-w-md sm:max-w-lg lg:max-w-none border-2 border-gray-200 rounded-2xl p-6 sm:p-8 lg:p-10 bg-white">
              <div className="relative aspect-square w-full">
                <img src="https://encrypted-tbn2.gstatic.com/shopping?q=tbn:ANd9GcTaIVlQpLopb3sdHNvBUNz8gU26Nj7CyXHSaZLgu3eIQi3Aom_1MwCfeNPs6FT9FJVxZFRQkUlnbrmlN5r6gGgZLqU2u7LSOOKd6h8GMQgd5Y5RhZGE0CXv&usqp=CAc" 
                className="object-contain w-full h-full"
          alt="Smartwatch Apple The 2025 New Model of Sports Fashion Smart Watch Features a Fully Touch-Sensitive High-Definition Display, Supports Wireless Calling (Answering/Making Calls), Message Notifications, Multiple Sports Modes/Pedometer/Ai Voice Control/Camera Control/Mus"
          />
              </div>
            </div>
          </div>
