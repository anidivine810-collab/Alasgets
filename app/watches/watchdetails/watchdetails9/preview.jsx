          ...
          <div className="flex justify-center lg:justify-end">
            <div className="w-full max-w-md sm:max-w-lg lg:max-w-none border-2 border-gray-200 rounded-2xl p-6 sm:p-8 lg:p-10 bg-white">
              <div className="relative aspect-square w-full">
                <img src="https://encrypted-tbn3.gstatic.com/shopping?q=tbn:ANd9GcQSaAFesRvm862IHlWzVYbv67BOB05Rw58_NE197cwaUVzD2LN5sCFtQQR_Bx3frd4Nw_G72Trc3k2D9Rl6phXVoNfnfJqgcRreiQ3FQmZzk1K0WaffQaoH4jiKlvi4yMgv4lV3Wg&usqp=CAc" 
                className="object-contain w-full h-full"
          alt="S8 Ultra 4g Smartwatch Ultra smart watch with 7 straps, Ocean Sport Bands for The for apple Watch Ultra 2 And Other Models"
          />
              </div>
            </div>
          </div>
