          ...
          <div className="flex justify-center lg:justify-end">
            <div className="w-full max-w-md sm:max-w-lg lg:max-w-none border-2 border-gray-200 rounded-2xl p-6 sm:p-8 lg:p-10 bg-white">
              <div className="relative aspect-square w-full">
                <img src="https://encrypted-tbn3.gstatic.com/shopping?q=tbn:ANd9GcQkoNO5rDOxFvNDsRc4O4dtOBIjwLoFbSX8LJwBkQp0KmDCUrAjG0uvKNlGg4R2EJVldq4E7sg8bjrWCIkYqx_7r_s_fxLvBVatKvPTLJfiAxi0_JtnRyT6S-Ub1Q&usqp=CAc" 
                className="object-contain w-full h-full"
          alt="1.91-inch HD Large-Screen Smart watch by SENOBONO: Packed with Features - Camera, Album, Recording, Dynamic Dials, Wireless Call, Message Notifications, Multiple Sport Modes, Local Music, Alarm Clock Watch"
          />
              </div>
            </div>
          </div>
