          ...
          <div className="flex justify-center lg:justify-end">
            <div className="w-full max-w-md sm:max-w-lg lg:max-w-none border-2 border-gray-200 rounded-2xl p-6 sm:p-8 lg:p-10 bg-white">
              <div className="relative aspect-square w-full">
                <img src="https://encrypted-tbn3.gstatic.com/shopping?q=tbn:ANd9GcQW46154sCvPEnyKyInyd6myjbG_dWKUg7GgeITEEk2WWwns-fJaEPNpbt17BVcfLW7j6CZstjCgfErBirfekwYIQv4n3ehrogVab-3gqlBm7sXKx9T547D&usqp=CAc" 
                className="object-contain w-full h-full"
          alt="2025 new 1000mAh battery smart watch, same for men and women, 1.85-inch HD display, wireless call/voice assistant, weather, High Quality smart watch, more than 100 sports modes, fitness tracker"
          />
              </div>
            </div>
          </div>
