          ...
          <div className="flex justify-center lg:justify-end">
            <div className="w-full max-w-md sm:max-w-lg lg:max-w-none border-2 border-gray-200 rounded-2xl p-6 sm:p-8 lg:p-10 bg-white">
              <div className="relative aspect-square w-full">
                <img src="https://encrypted-tbn1.gstatic.com/shopping?q=tbn:ANd9GcSNfDF7w2mySeK2zCY3HJ6MtY6wI8kXi7CjWIDovJZMq6wgnIBZf3s3_aosfgEBzmB5HBhRUaDR7IsxwAXSZ8e_kRCCGRt-I1sfdJZzy2kwUOGCLBEXmkPU7TAmgBnz&usqp=CAc" 
                className="object-contain w-full h-full"
          alt="Sports smartwatch with wireless calling, music management, information push and read, various exercise modes, pedometer, USB rechargeable lithium battery, and high-definition display screen - compatible with iPhone and Android, Men's and Women's"
          />
              </div>
            </div>
          </div>
