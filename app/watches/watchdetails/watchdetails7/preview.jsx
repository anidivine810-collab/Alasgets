          ...
          <div className="flex justify-center lg:justify-end">
            <div className="w-full max-w-md sm:max-w-lg lg:max-w-none border-2 border-gray-200 rounded-2xl p-6 sm:p-8 lg:p-10 bg-white">
              <div className="relative aspect-square w-full">
                <img src="https://encrypted-tbn1.gstatic.com/shopping?q=tbn:ANd9GcSgwpE_UHqeEZbYA_lxT1xdX3FFIm3g59UCPijdjMs8xVr7l4mzRWbk-myjEkmIdr2hfKusZsxXdwIMoXb-7ZHRcPDKqcKgvG3yQUhQvZWF&usqp=CAc" 
                className="object-contain w-full h-full"
          alt="Generic - 1.65-inch IP67 waterproof full touch smartwatch with Bluetooth calling"
          />
              </div>
            </div>
          </div>
