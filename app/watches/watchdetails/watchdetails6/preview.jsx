          ...
          <div className="flex justify-center lg:justify-end">
            <div className="w-full max-w-md sm:max-w-lg lg:max-w-none border-2 border-gray-200 rounded-2xl p-6 sm:p-8 lg:p-10 bg-white">
              <div className="relative aspect-square w-full">
                <img src="https://encrypted-tbn1.gstatic.com/shopping?q=tbn:ANd9GcQFYGX3lrpVwAoVO5Qi7erovN4OARY_1IsT0IZ9D95Q7_NC44EeT9SHJzYzSH2777cOm-Ao134jGTyflEOIsOZYV442MBzGOeztIqpRzvMb&usqp=CAc" 
                className="object-contain w-full h-full"
          alt="2025 new Men's outdoor multifunctional sports smartwatch, fitness tracker, three different watch straps, wireless calling, message notification, high-definition full touch screen, flashlight, pedometer"
          />
              </div>
            </div>
          </div>
