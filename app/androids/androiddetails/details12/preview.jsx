          ...
          <div className="flex justify-center lg:justify-end">
            <div className="w-full max-w-md sm:max-w-lg lg:max-w-none border-2 border-gray-200 rounded-2xl p-6 sm:p-8 lg:p-10 bg-white">
              <div className="relative aspect-square w-full">
                <img src="https://encrypted-tbn2.gstatic.com/shopping?q=tbn:ANd9GcStAaF2YPEKGLXa8kW9tzqBWSS25nkAP9fq5HNiYkmF3jY9UNNhcOq76V9QgWhWGPWm81t0qPv2ZjHXg3eQt1W4Uj95Il2tLLmW8jPSkUDlPpyggHt6uLi-thoUaIfpSGPV&usqp=CAc" 
                className="object-contain w-full h-full"
          alt="Realme 16 Pro max phone, Tecno Spark 40 Mobile Phone, New Global Unlocked"
          />
              </div>
            </div>
          </div>
