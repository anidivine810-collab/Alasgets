          ...
          <div className="flex justify-center lg:justify-end">
            <div className="w-full max-w-md sm:max-w-lg lg:max-w-none border-2 border-gray-200 rounded-2xl p-6 sm:p-8 lg:p-10 bg-white">
              <div className="relative aspect-square w-full">
                <img src="https://encrypted-tbn1.gstatic.com/shopping?q=tbn:ANd9GcTz9gpWQxK86OQLrqcen-4TiMFcMObXXzaoQJrjfnqD_6SyHTzt0M3jcgtOGj9S1jMIs9a2GPmojnZTLnqLNkyUH4r1mC0tkzxVTUtlqeoDZEeVR3Wq--CgqUS-1U_2qJ-17g&usqp=CAc" 
                className="object-contain w-full h-full"
          alt="New Dual SIM 5G Smartphone, 6.8-inch HD Screen, 8GB+256GB Storage, Android 13 System, Face Recognition Unlock, Light Luxury Texture High Quality Feel, Includes Screen Protector and, Phone Case, No Data Cable And Earphones"
          />
              </div>
            </div>
          </div>
