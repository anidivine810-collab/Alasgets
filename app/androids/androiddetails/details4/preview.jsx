          ...
          <div className="flex justify-center lg:justify-end">
            <div className="w-full max-w-md sm:max-w-lg lg:max-w-none border-2 border-gray-200 rounded-2xl p-6 sm:p-8 lg:p-10 bg-white">
              <div className="relative aspect-square w-full">
                <img src="https://encrypted-tbn3.gstatic.com/shopping?q=tbn:ANd9GcQ5H8lxzUyEm6U23WcCFJJ6qNUjZpqqz4aGRY6iix4Ma8a9y6rGEIUjN2KEYCyb_6OEEg731mo9zwl5tvqq3tABYlVZ-lBGLZJEKSSy2EmB5CZMBE3SlAYSFf45&usqp=CAc" 
                className="object-contain w-full h-full"
          alt="The New Flip Phone, Small and Convenient, Not Easy to Be Found, Standby Time 150 Hours, Use Time 12 Hours, with Built-in Flashlight, Suitable for Use as a Backup Machine, 2G Network, You Can Listen to Music, Suitable for Camping, Mountainous Areas"
          />
              </div>
            </div>
          </div>
