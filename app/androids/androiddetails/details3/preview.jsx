          ...
          <div className="flex justify-center lg:justify-end">
            <div className="w-full max-w-md sm:max-w-lg lg:max-w-none border-2 border-gray-200 rounded-2xl p-6 sm:p-8 lg:p-10 bg-white">
              <div className="relative aspect-square w-full">
                <img src="https://encrypted-tbn0.gstatic.com/shopping?q=tbn:ANd9GcRQ_8AGPB0oFSUnoSvO_xZABpr5-XMvuvPlz7RU_XvjV4HyL8tTK5LzhKR7zhY2W2d5yxQ_LN0jM-e7-rMx-Y8xrsyliY5LsOSo7fGJJ7ELglzbIqriZIMxxbC0JUjZMCQzKXStpQ&usqp=CAc" 
                className="object-contain w-full h-full"
          alt="Carmon 40 Pro 512gb, 5g Mobile Dual Card Dual Standby 4G Unlocked Version High-Quality Smartphone | Android 10 System, 8GB RAM, 256GB Storage, 6.56-inch Touch Screen, 8MP+16MP Camera, 3000mAh Batter"
          />
              </div>
            </div>
          </div>
