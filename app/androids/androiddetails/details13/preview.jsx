          ...
          <div className="flex justify-center lg:justify-end">
            <div className="w-full max-w-md sm:max-w-lg lg:max-w-none border-2 border-gray-200 rounded-2xl p-6 sm:p-8 lg:p-10 bg-white">
              <div className="relative aspect-square w-full">
                <img src="https://encrypted-tbn1.gstatic.com/shopping?q=tbn:ANd9GcS6INryzK2bX9mpMCcnMGvuj4IZA7b3CoJBbIrx0OgLBeQvFPO4V3lG2aNJTIGYHm3ZJ2_MZeh3yHoiwFLYSUgd1Ou4O6F3UJByuoQ_yp9ByrhtqXHsIbIiNtuM-3vpKQnqBA&usqp=CAc" 
                className="object-contain w-full h-full"
          alt="Google Pixel 10 Pro mobile Phone Googles Android equipped with equipped with 8GB+256GB large storage space, Android 12 system unlocking smartphone, 6.82-inch high-definition display screen, dual SIM cards, 16MP+50MP front and rear ultra high definition cameras, long-life battery"
          />
              </div>
            </div>
          </div>
