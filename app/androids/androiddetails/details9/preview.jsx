          ...
          <div className="flex justify-center lg:justify-end">
            <div className="w-full max-w-md sm:max-w-lg lg:max-w-none border-2 border-gray-200 rounded-2xl p-6 sm:p-8 lg:p-10 bg-white">
              <div className="relative aspect-square w-full">
                <img src="https://encrypted-tbn1.gstatic.com/shopping?q=tbn:ANd9GcQeIX_9OArFcPwnU_TsNWGyDLYekNxCNGmoeTJX4BVA-eYnpBYY_wMICQ3OV25_tApMpAhmVOLLGGGCnfNtieKEp8T9Sau8ZEI1ZIAgdkL-W6D2Aa88Hx59cymYpGfGQkmOT7BY6DY&usqp=CAc" 
                className="object-contain w-full h-full"
          alt="8GB+256GB RAM 6.8-Inch HD + 5G Android Phone, Dual SIM Unlock, Battery, Facial Recognition Unlock, GPS, Built-In Pen, Global Unlock, New Smartphone, Holiday Birthday Gift, Includes Charging Cable, Protective Case, Screen Protector, Travel Phone"
          />
              </div>
            </div>
          </div>
