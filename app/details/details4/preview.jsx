        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 xl:gap-12 items-start">
            ...
            <div className="w-full max-w-md sm:max-w-lg lg:max-w-none border-2 border-gray-200 rounded-2xl p-6 sm:p-8 lg:p-10 bg-white">
              <div className="relative aspect-square w-full">
                <img
                  ...
                  alt="Generic - S10 Ultra 22 Full Touch Screen Smart Watch - For Andriod IOS"
          ...
          <div className="lg:mt-4">
            ...
            <div className="flex flex-col gap-4 max-w-md">
              <button
                disabled={processing}
                className="w-full bg-red-600 hover:bg-red-700 active:bg-red-800 text-white py-4 px-6 font-medium rounded-lg transition-colors duration-200 text-lg disabled:opacity-60"
              >
                Buy Now
              </button>
              ...
              <button
                ...
                disabled={processing}
                className="w-full border-2 border-gray-800 hover:bg-gray-50 active:bg-gray-100 text-gray-800 py-4 px-6 font-medium rounded-lg transition-colors duration-200 text-lg disabled:opacity-60 flex items-center justify-center"
              >
                {processing ? (
